...
// Mother present?
router.post('/v2/issue-maternity-exemption-certificates/signed-in/mother-present', function (req, res) {

  var motherPresent = req.session.data['mother-present']

  if (motherPresent  === "yes"){
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/about-mother')
  }
  else if (motherPresent === "no") {
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/date-met-with-mother')
  }
  else {
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/mother-present-error')
  }

})

// Date met with mother
router.post('/v2/issue-maternity-exemption-certificates/signed-in/date-met-with-mother', function (req, res) {
  ...
  if (dateMetWithMother){
    ...
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/date-met-with-mother-error')
  }

})

// About mother
router.post('/v2/issue-maternity-exemption-certificates/signed-in/about-mother', function (req, res) {
  ...
  if (mothersFirstName && mothersLastName && mothersDateOfBirth && mothersNHSNumber && mothersPostcode && dueBirthDate){
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/mother-exemption-method')
  }
  else {
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/about-mother-error')
  }

})

// Mother exemption method
router.post('/v2/issue-maternity-exemption-certificates/signed-in/mother-exemption-method', function (req, res) {

  var motherExemptionMethod = req.session.data['mother-exemption-method']

  if (motherExemptionMethod === "email"){
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/mother-email-address')
  }
  else if (motherExemptionMethod === "post") {
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/mother-postal-address')
  }
  else {
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/mother-exemption-method-error')
  }

})

// Mothers email address
router.post('/v2/issue-maternity-exemption-certificates/signed-in/mother-email-address', function (req, res) {

  var mothersEmailAddress = req.session.data['mothers-email-address']

  if (mothersEmailAddress){
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/check-your-answers')
  }
  else {
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/mother-email-address-error')
  }

})

// Mothers postal address
router.post('/v2/issue-maternity-exemption-certificates/signed-in/mother-postal-address', function (req, res) {
  ...
  if (mothersBuildingName && mothersStreetName && mothersTownCity && mothersPostalPostcode){
    ...
    res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/mother-postal-address-error')
  }

})

// Capture NHSMail address (Login)
router.post('/v2/issue-maternity-exemption-certificates/nhs-login', function (req, res) {

var nhsLogin = req.session.data['nhs-mail-address']

if (nhsLogin === ""){
  req.session.data['nhs-mail-address'] = "joe.bloggs@nhs.net";
  res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/start')
}
else if (nhsLogin) {
  res.redirect('/v2/issue-maternity-exemption-certificates/signed-in/start')
}
...
router.post('/v2/issue-maternity-exemption-certificates/register/have-nhs-mail', function (req, res) {

var nhsMail = req.session.data['nhs-mail']

if (nhsMail === "yes"){
  res.redirect('/v2/issue-maternity-exemption-certificates/register/nhs-mail-address')
}
else if (nhsMail === "no") {
  res.redirect('/v2/issue-maternity-exemption-certificates/register/nhs-mail-kickout')
}
else {
  res.redirect('/v2/issue-maternity-exemption-certificates/register/have-nhs-mail-error')
}

})

// NHSMail address
router.post('/v2/issue-maternity-exemption-certificates/register/nhs-mail-address', function (req, res) {

var nhsMailAddress = req.session.data['nhs-mail-address']

if (nhsMailAddress.endsWith('@nhs.net')){
  res.redirect('/v2/issue-maternity-exemption-certificates/register/register')
}
else {
  res.redirect('/v2/issue-maternity-exemption-certificates/register/nhs-mail-address-error')
}
...
router.post('/v2/issue-maternity-exemption-certificates/register/nhs-mail-address-confirm', function (req, res) {
...
if (nhsMailAddressConfirm === "yes"){
  ...
  res.redirect('/v2/issue-maternity-exemption-certificates/register/nhs-mail-address-confirm-error')
}

})

// Email confirmation sent
router.post('/v2/issue-maternity-exemption-certificates/register/email-confirmation-sent', function (req, res) {

var emailConfirmationSent = req.session.data['nhs-mail-address']

if (emailConfirmationSent){
  res.redirect('/v2/issue-maternity-exemption-certificates/register/nhs-mail-address-confirm-email')
}
else {
  res.redirect('/v2/issue-maternity-exemption-certificates/register/email-confirmation-sent-error')
}
...
router.post('/v2/issue-maternity-exemption-certificates/register/nhs-mail-address-confirm-email', function (req, res) {

var nhsMailAddressConfirmEmail = req.session.data['nhs-mail-address-confirm-email']

if (nhsMailAddressConfirmEmail === "yes"){
  res.redirect('/v2/issue-maternity-exemption-certificates/register/email-confirmation-sent')
}
else if (nhsMailAddressConfirmEmail === "no") {
  res.redirect('/v2/issue-maternity-exemption-certificates/register/email-confirmation-sent-error')
}
else {
  res.redirect('/v2/issue-maternity-exemption-certificates/register/nhs-mail-address-confirm-email-error')
}

})

// User details
router.post('/v2/issue-maternity-exemption-certificates/register/register', function (req, res) {
...
if (usersLastName && usersNMCPin && usersDOBDay && usersDOBMonth && usersDOBYear){
  res.redirect('/v2/issue-maternity-exemption-certificates/register/check-your-answers')
}
else {
  res.redirect('/v2/issue-maternity-exemption-certificates/register/register-error')
}

})

// User registration - check your answers
router.post('/v2/issue-maternity-exemption-certificates/register/check-your-answers', function (req, res) {

res.redirect('/v2/issue-maternity-exemption-certificates/register/registration-verified')

})

// Capture NHSMail address (Register)
router.post('/v2/issue-maternity-exemption-certificates/register-nhs-login', function (req, res) {

var nhsLogin = req.session.data['nhs-mail-address']

if (nhsLogin === ""){
  req.session.data['nhs-mail-address'] = "joe.bloggs@nhs.net";
  res.redirect('/v2/issue-maternity-exemption-certificates/register-ms-permissions')
}
else if (nhsLogin) {
  res.redirect('/v2/issue-maternity-exemption-certificates/register-ms-permissions')
}
